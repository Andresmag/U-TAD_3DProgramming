...
///////////////////////////////////////////////////// OPENGL INIT ////////////////////////////////////////////////////////////////
	...
	GLFWwindow* win = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "Practica 1.5", nullptr, nullptr);
	if (!win) {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	GunslingerModel->setPosition(glm::vec3(-10, 0, 0));
	GunslingerModel->setRotation(glm::vec3(0, -40, 0));
	GunslingerModel->setScale(glm::vec3(1, 1, 1));

	std::shared_ptr<Model> BoxModel = std::make_shared<Model>(Mesh::load("data/box_stack.obj"));
	BoxModel->setPosition(glm::vec3(20, -17, 0));
	BoxModel->setRotation(glm::vec3(0, 0, 0));
	BoxModel->setScale(glm::vec3(6, 6, 6));
